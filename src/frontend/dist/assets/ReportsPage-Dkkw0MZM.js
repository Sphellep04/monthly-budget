import { j as jsxRuntimeExports, g as cn, r as reactExports, am as useGetExpensesInRange, ao as useGetCategoryBreakdownForRange, i as useMonthlySummary, B as Button, S as Skeleton } from "./index-Cwi0T1AC.js";
import { B as Badge } from "./badge-Ca7w2zry.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-Bj8oXA5U.js";
import { f as formatCents } from "./index-DBqnxCSC.js";
import { D as Download } from "./download-Cd8guNrC.js";
import { R as ResponsiveContainer, I as BarChart, X as XAxis, Y as YAxis, H as Tooltip, J as Bar, s as Cell } from "./BarChart-j8Y__f7G.js";
import { R as Receipt } from "./receipt-Dq58PUVj.js";
import { F as FileText } from "./file-text-DNJMe75p.js";
...
function ReportSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "reports.loading_state", children: [
...
function ReportsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter p-4 md:p-6 max-w-6xl mx-auto space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-subtle", "data-ocid": "reports.date_range_panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-start sm:items-end", children: [
        ...
        startDate && endDate && startDate > endDate && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
        ...
        Card,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: [...expenses].sort((a, b) => b.date.localeCompare(a.date)).map((expense, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TableRow,
                {
