...
function AlertsPanel({
  ...
  if (alerts.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-3.5 rounded-xl bg-emerald-500/8 border border-emerald-500/20", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card shadow-subtle overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-56", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: alerts.map((s, _i) => {
      const status = getBudgetStatus(s, alertThreshold);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 p-5 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                pct,
                color: pct >= 100 ? "#ef4444" : pct >= alertThreshold ? "#f59e0b" : accentColor
              }
            )
          ] })
        ] }),
...
function MonthlySummaryHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden shadow-subtle slide-up animate-stagger-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-border/60", children: stats.map(
      ({
        icon: Icon,
        label,
        value,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `h-4 w-4 ${iconColor}` })
          }
        ),
...
function DashboardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 md:p-7 space-y-7 max-w-7xl mx-auto page-enter", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(BudgetGridSkeleton, {}) : hasBudgets ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: budgets.map((bs, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        BudgetCard,
        {
          summary: bs,
          index: i + 1,
