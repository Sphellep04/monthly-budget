import { c as createLucideIcon, a3 as useMonthlyTrend, a5 as useCategoryBreakdown, a6 as useDailySpending, h as useMonthlySummary, j as jsxRuntimeExports, ae as Lightbulb, S as Skeleton, T as TriangleAlert } from "./index-Dp0P1DkE.js";
...
function InsightsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-full bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-6 max-w-7xl mx-auto", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(InsightsLoader, {}) : insights.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyInsights, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4", children: insights.map((insight, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(InsightCard, { insight, index: i }, insight.id)) }),
