import { c as createLucideIcon, r as reactExports, h as useMonthlySummary, af as useSearchExpenses, ag as useGetExpensesInRange, j as jsxRuntimeExports, ah as Search, B as Button, X, v as Label, I as Input, S as Skeleton } from "./index-Dp0P1DkE.js";
...
function SearchPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 px-4 md:px-6 py-6 max-w-5xl mx-auto w-full space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-subtle p-5 space-y-4", children: [
      ...
      !isLoading && results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-subtle overflow-hidden", children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 space-y-3", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 rounded-lg" }, i)) }) : results.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 px-6 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: results.map((expense, _idx) => {
