import { c as createLucideIcon, r as reactExports, ar as useListBillPayments, j as jsxRuntimeExports, B as Button, S as Skeleton, as as Bell, at as useListBudgets, a4 as useRecurringTemplates, L as Link, au as useCreateBillPayment, av as useUpdateBillPayment, H as Dialog, J as DialogContent, K as DialogHeader, M as DialogTitle, y as Label, I as Input, C as CircleCheck, O as ue } from "./index-Cwi0T1AC.js";
import { B as Badge } from "./badge-Ca7w2zry.js";
import { M as MonthSelector } from "./MonthSelector-2wBC3y9D.js";
import { a as getMonthName, C as CATEGORY_ICONS, f as formatCents } from "./index-DBqnxCSC.js";
import { D as Download } from "./download-Cd8guNrC.js";
import { E as ExternalLink } from "./external-link-DdwW19Mb.js";
import { C as CircleAlert } from "./circle-alert-eawZ90rx.js";
import "./chevron-left-BLK5gBxu.js";
import "./chevron-right-Dz6B49L3.js";
/**
...
function MarkPaidDialog({ bill, year, month, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!bill, onOpenChange: () => onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", "data-ocid": "bills.mark_paid.dialog", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: isPending ? "Saving…" : "Confirm Payment"
          }
        )
      ] })
    ] })
...
function BillCard({ bill, index, onMarkPaid }) {
      ...
      children: [
        ...
        !isLoading && budgets.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: filterTabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "bills.loading_state", children: [1, 2, 3].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 rounded-2xl" }, k)) }) : budgets.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyStateNoTemplates, {}) : filteredBills.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: filteredBills.map((bill, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          BillCard,
          {
            bill,
            index: i,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/budgets", "data-ocid": "bills.go_to_budgets_button", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "gap-2 rounded-xl h-10 shadow-elevated", children: [
