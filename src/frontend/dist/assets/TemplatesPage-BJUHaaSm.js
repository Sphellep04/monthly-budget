import { c as createLucideIcon, l as useActor, aw as useQuery, ax as useQueryClient, ay as useMutation, n as createActor, E as useBudgets, r as reactExports, j as jsxRuntimeExports, az as BookDashed, B as Button, S as Skeleton, U as CalendarDays, i as useMonthlySummary, H as Dialog, J as DialogContent, K as DialogHeader, M as DialogTitle, N as DialogDescription, y as Label, I as Input, m as LoaderCircle, ah as useNavigate, O as ue } from "./index-Cwi0T1AC.js";
...
import { P as Plus, T as Trash2 } from "./alert-dialog-T5spQLU5.js";
...
function RenameDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!template, onOpenChange: () => onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
...
function TemplatesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-full bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-6 py-6", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4",
        "data-ocid": "templates.loading_state",
        children: [1, 2, 3].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 rounded-xl" }, k))
      }
