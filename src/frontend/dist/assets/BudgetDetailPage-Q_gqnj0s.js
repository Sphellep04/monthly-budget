import { c as createLucideIcon, J as useAddExpense, r as reactExports, H as ue, j as jsxRuntimeExports, z as Dialog, A as DialogContent, C as DialogHeader, E as DialogTitle, G as DialogDescription, K as CalendarDays, I as Input, M as StickyNote, X, B as Button, _ as __vitePreload, v as Label, N as useDeleteExpense, S as Skeleton, O as useCreateRecurringTemplate, Q as useUpdateRecurringTemplate, W as Wallet, U as useDeleteRecurringTemplate, V as useParams, Y as useBudgetSummary, Z as useExpenses, $ as useRecurringTemplates, L as Link, T as TriangleAlert } from "./index-Dp0P1DkE.js";
...
import { f as formatCents, g as getBudgetStatus, C as CATEGORY_ICONS } from "./index-DBqnxCSC.js";
...
const CalendarClock = createLucideIcon("calendar-clock", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const NotepadText = createLucideIcon("notepad-text", __iconNode$3);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function extractLargestAmount(text) {
  const pattern = /(?:N\$|R|\$)?\s*(\d{1,3}(?:[,\s]\d{3})*(?:\.\d{1,2})?|\d+(?:\.\d{1,2})?)/g;
  const matches = [];
  let m;
...
async function runOCR(imageDataUrl) {
  const { createWorker } = await __vitePreload(async () => {
    const { createWorker: createWorker2 } = await import("./index-B2CorQwb.js").then((n) => n.i);
...
function ExpenseForm({
  ...
  const [receiptDataUrl, setReceiptDataUrl] = reactExports.useState(null);
  ...
  function applyReceiptFile(file, preview) {
    setReceiptFile(file);
  ...
  const handleCameraCapture = reactExports.useCallback(
    async (e) => {
      var _a;
      const file = (_a = e.target.files) == null ? void 0 : _a[0];
      if (!file) return;
      ...
      try {
        ...
        if (amount) {
          ...
          setAmountError("");
          setScanState("done");
          ue.success(`Receipt scanned — amount detected: N$${amount}`, {
            description: "You can adjust the amount before saving.",
            duration: 5e3
          });
        } else {
          setScanState("failed");
          ue.warning("Amount not detected", {
            description: "Could not find an amount on the receipt. Please enter it manually.",
            duration: 6e3
          });
        }
      } catch {
        setScanState("failed");
        ue.warning("OCR scan failed", {
          description: "Could not scan the receipt. Please enter the amount manually.",
          duration: 6e3
        });
      }
    },
  ...
  const isBusy = addExpense.isPending || isUploading || scanState === "scanning";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md bg-card border-border shadow-premium backdrop-blur-md", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5 pt-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          scanState === "done" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-3 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ScanLine,
            {
        ...
        amountError && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1.5 text-xs text-destructive mt-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        receiptPreview ? (
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-xl border border-border overflow-hidden bg-muted/20 group", children: [
            ...
            scanState === "scanning" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-background/70 backdrop-blur-sm flex flex-col items-center justify-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-10 h-10", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { className: "w-5 h-5 text-primary absolute inset-0 m-auto" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-foreground", children: "Scanning receipt…" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Extracting amount with OCR" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
            ...
            receiptFile && scanState !== "scanning" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-1.5 bg-muted/40 border-t border-border flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground truncate flex-1 min-w-0", children: receiptFile.name }),
              scanState === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-[10px] text-primary font-medium shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center group-hover:bg-primary/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-3.5 h-3.5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-primary leading-tight", children: "Scan Receipt" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground leading-tight", children: "Use camera to auto-fill amount" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { className: "w-3.5 h-3.5 text-primary/60 ml-auto shrink-0" })
                ]
              }
            )
          ] })
        ...
        receiptError && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1.5 text-xs text-destructive mt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-3.5 h-3.5 shrink-0" }),
          receiptError
        ] }),
        isUploading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: isBusy ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              isUploading ? "Uploading…" : scanState === "scanning" ? "Scanning…" : "Saving…"
            ] }) : "Add Expense"
          }
        )
      ] })
...
function ExpenseList({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 rounded-xl" }, i)) });
  }
  if (expenses.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-14 text-center gap-3 rounded-2xl border border-dashed border-border bg-muted/20", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border overflow-hidden shadow-subtle bg-card divide-y divide-border", children: expenses.map((expense, _idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
function RecurringTemplateForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md shadow-premium backdrop-blur-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
...
function RecurringTemplateList({
  ...
  if (templates.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-10 px-6 text-center rounded-2xl border border-dashed border-border bg-muted/20", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: templates.map((t, _i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
function BudgetDetailPage() {
  ...
  if (summaryLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 space-y-5 max-w-2xl mx-auto", children: [
  ...
  if (!summary) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 max-w-2xl mx-auto text-center py-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/budgets", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 space-y-6 max-w-2xl mx-auto page-enter", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to: "/budgets",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "All Budgets" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card shadow-elevated space-y-6 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pb-6 space-y-5", children: [
        ...
        ].map(({ label, value, className }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card px-4 py-3 text-center", children: [
