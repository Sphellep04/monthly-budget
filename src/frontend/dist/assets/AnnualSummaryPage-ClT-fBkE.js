import { c as createLucideIcon, ab as useSearch, ac as useNavigate, ad as useAnnualSummary, j as jsxRuntimeExports, K as CalendarDays, W as Wallet, S as Skeleton } from "./index-Dp0P1DkE.js";
...
function MonthTable({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-auto -mx-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[520px] space-y-1", children: rows.map((row, i) => {
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-start justify-between gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 rounded-xl border border-border bg-card px-1 py-1 shadow-subtle shrink-0 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
