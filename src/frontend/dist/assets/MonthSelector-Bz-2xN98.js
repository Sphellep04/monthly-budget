import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button } from "./index-Dp0P1DkE.js";
...
function MonthSelector({ year, month, onChange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 bg-card border border-border rounded-xl px-1 py-1 shadow-subtle", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 px-3 min-w-[156px] justify-center overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-2 ${labelAnim}`, children: [
