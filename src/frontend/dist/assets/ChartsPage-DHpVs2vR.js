import { G as commonjsGlobal, H as getDefaultExportFromCjs, r as reactExports, I as clsx, R as React, J as invariant, k as useBudgets, j as jsxRuntimeExports, T as TrendingUp, K as ChartNoAxesColumn, S as Skeleton, M as useMonthlyTrend, N as useCategoryTrend } from "./index-CWkzYjiE.js";
...
function formatMonthLabel(year, month) {
  const m2 = new Date(Number(year), Number(month) - 1, 1);
  return m2.toLocaleString("en-US", { month: "short", year: "2-digit" });
}
function SpendingTrendChart() {
  const { data: trend, isLoading } = useMonthlyTrend(12);
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 w-full rounded-xl" });
  }
  const chartData = (trend ?? []).sort((a2, b2) => {
    if (a2.year !== b2.year) return Number(a2.year) - Number(b2.year);
    return Number(a2.month) - Number(b2.month);
  }).map((p2) => ({
    month: formatMonthLabel(p2.year, p2.month),
    total: Number(p2.totalSpentCents) / 100
  }));
...
function CategoryBreakdownChart({
  ...
  const chartData = (trend ?? []).sort((a2, b2) => {
    ...
    month: formatMonthLabel(p2.year, p2.month),
    spent: Number(p2.spentCents) / 100,
    limit: Number(p2.limitCents) / 100
  }));
  const color2 = CHART_COLORS[colorIndex % CHART_COLORS.length];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    BarChart,
    {
      data: chartData,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: "Spending Charts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5 font-body", children: "Visualize your spending trends over time" })
        ] }),
          ...
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground", children: "Total Spending Trend" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Last 12 months" })
                ] })
              ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", "data-ocid": "charts.category_trends.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-accent/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "w-4 h-4 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground", children: "Per-Budget Breakdown" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Last 6 months — bars show spent vs. limit" })
            ] })
          ] }),
          budgetsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: ["a", "b", "c", "d"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-56 rounded-xl" }, k2)) }) : summaries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-10 w-10 text-muted-foreground mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: "No budgets found for this month. Create budgets to see charts." })
              ]
            }
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-sm font-semibold text-foreground truncate", children: bs.budget.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground ml-auto shrink-0", children: bs.budget.category })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
