-- Extends import_all_data (0003, 0007, 0009, 0011) to cover the new accounts
-- table, so a backup/restore round-trip doesn't silently drop account balances.
...
begin
  ...
  insert into accounts (owner, name, type, balance_cents, created_at)
