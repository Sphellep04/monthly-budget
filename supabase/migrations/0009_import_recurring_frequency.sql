-- Extends import_all_data (0003, 0007) so restoring a backup carries forward
-- each recurring item's frequency/anchor_month instead of silently resetting
-- everything to the 'monthly' column default.
